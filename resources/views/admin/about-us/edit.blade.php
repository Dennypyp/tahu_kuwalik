                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="category" id="category">
                                            <option value="Ranah Tahu Kuwalik" @if($about->category=="Ranah Tahu Kuwalik") selected @endif>Ranah Tahu Kuwalik</option>
                                            <option value="Program Tahu Kuwalik"  @if($about->category=="Program Tahu Kuwalik") selected @endif>Program Tahu Kuwalik</option>
